...
const gachas = [
    ...
    new Gacha("The Duncans", 1, 3, 2, 4, "weakAll", "A USAmerican vaudeville duo who I now regret putting into this game after reading that their most popular act was just blackface.", "https://en.wikipedia.org/wiki/File:It%27s_a_Great_Life_lobby_card_2.jpg"),
    ...
    new Gacha("\"Entrepreneur\"", 10, 0, 0, 3, "strong", "This dork's power is posting on social media and sending friend requests on Business Social Media Site. Am I allowed to mention specific sites by name? Like, what's the law on that? This is a free game so it's probably fine, but like, hmm... Laws are great. I'm glad we have them.", "https://foter.com/photo2/studio-shot-of-young-man-working-on-laptop/"),
    new Gacha("Floppies to Copy", 10, 1, 0, 3, "weakAll", "To some, these are a nostalgic piece of tech history. But to the worst people, they are prime content for hundreds of obnoxious memes about how MILLENNIALS DON'T KNOW WHAT *THESE* ARE! Millennials are in their 20s and 30s, Barbara. We know what a ****ing floppy disk is.", "https://foter.com/photo2/diskettes-on-white-background/"),
    new Gacha("The Intern", 10, 2, 0, 3, "speed2", "When older people are complaining about how kids these days are big babies and all that crap, just pretend they're talking about literal babies. No, Old Man Jenkins isn't mad that the barista said \"no problem\" instead of \"you're welcome,\" becauuse that'd be silly. He's mad that the barista is 8 months old. That has to be it.", "https://foter.com/photo2/portrait-of-baby-boy-playing-on-laptop/"),
    new Gacha("Byzantine Saint", 10, 3, 0, 3, "heal", "She is pointing at a book to inform you that the word \"book\" starts with the letter \"B.\" Can you think of any other words that start with the letter \"B?\" I'd sure hope so, given the name of this saint and all.", "https://www.fromoldbooks.org/Racinet-Ornament/pages/099-001-detail-byzantine-style-saint/"),
    new Gacha("Earth", 10, 0, 1, 3, "shieldAll2", "This is where everything happens. Every single embarrassing thing you've ever done has happened here. You gotta branch out, yo. Go to Mars and moon the Mars Rover on accident.", "https://en.wikipedia.org/wiki/File:The_Earth_seen_from_Apollo_17.jpg"),
    new Gacha("A BEE!!", 10, 1, 1, 5, "healWeak", "Another reminder that bees are good and important and you should do everything you can to save the bees, up to and including having your own body converted into a beehive after you die.", "http://www.public-domain-photos.com/insects/bee-7-4.htm"),
    new Gacha("Acorns", 10, 2, 1, 3, "sand", "Acorns are cool I used to collect them when I was running around parks and stuff when I was a kid and pretend I was like a squirrel or something like this post if you agree.", "http://www.public-domain-photos.com/objects/acorns-1.htm"),
    new Gacha("Mushroom", 10, 3, 1, 3, "poison", "Is this mushroom poisonous? Maybe. Maybe not. Am I going to find out? Definitely not. I don't even like mushrooms when I KNOW they aren't poisonous!", "http://www.public-domain-photos.com/objects/amanita-muscaria-1.htm"),
    new Gacha("Illoomanatties!!", 10, 0, 2, 3, "aggro", "What's more likely, a vast conspiracy thats gone on for centuries, or that sometimes people are evil or incompetent for entirely selfish reasons? Definitely the first one. Humans are good at keeping secrets, after all.", "http://www.public-domain-photos.com/miscellaneous/dollar-eye-4.htm"),
    new Gacha("Retro Woman", 10, 1, 2, 4, "shieldAll2", "She's hip! She's retro! She's running late for the rockabilly show downtown! Her boyfriend's beard hasn't been washed in weeks!", "http://www.publicdomainfiles.com/show_file.php?id=13548584418325"),
    new Gacha("The Sun", 10, 2, 2, 3, "debuff", "There are only two faces you can give the sun: a smiling baby's face or some creepy stare like this. There's nothing else. Anything else isn't the sun - it's some other star pretending.", "http://www.publicdomainfiles.com/show_file.php?id=13488928811745"),
    new Gacha("Football Francine", 10, 3, 2, 3, "speedAll2", "I hope one day this game is popular enough that this character makes a lot of USAmericans angry because I called it \"football\" instead of \"soccer.\" Actually, no, I don't hope that, because if this game gets popular at all, there's something wrong with society. Well, something ELSE wrong with it.", "http://www.publicdomainfiles.com/show_file.php?id=13488040818899"),
    new Gacha("Caddy Cat", 10, 0, 3, 4, "buff", "This cat is from a painting by Louis Wain, an artist now best known for his anthropomorphic cat drawings and paintings, which became more abstract as he was confined to a psychiatric hospital for his presumed schizophrenia.", "https://en.wikipedia.org/wiki/File:Wain_cat_--_representative.jpg"),
    new Gacha("Dante", 10, 1, 3, 4, "revive", "History's most famous comedian.", "https://en.wikipedia.org/wiki/File:DanteFresco.jpg"),
    new Gacha("Boy with Spaghetti", 10, 2, 3, 5, "healAll2", "This is what I would look like if I were alive in the 1800s.", "https://en.wikipedia.org/wiki/File:Moser_Spaghetti_essender_Junge.jpg"),
    new Gacha("Here Comes Mr. Pipe!", 10, 3, 3, 5, "poison2", "This is definitely a pipe.", "http://www.publicdomainfiles.com/show_file.php?id=14024302211626")
];